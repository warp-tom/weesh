...
// top_up, payment, transfer, refund
  ...
  @override
  String toString() {
    return 'WalletTransaction(id: $id, walletId: $walletId, amount: $amount, title: $title, description: $description, type: $type, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, walletId, amount, title, description, type, createdAt);
